CREATE TABLE patients_fn_bidx (
    pid INT UNSIGNED NOT NULL,
    cid INT NOT NULL,
    ibit TINYINT NOT NULL,
    CONSTRAINT `fk_fn_bid_p` FOREIGN KEY (`pid`) REFERENCES `patients` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_fn_bid_cid` FOREIGN KEY (`cid`) REFERENCES `customers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
